...
variables: VARIABLES (TIPO (
TIPO_ENTERO NOMBRE IDENTIFICADOR VALOR_INICIAL ENTERO
| TIPO_REAL NOMBRE IDENTIFICADOR VALOR_INICIAL REAL
| TIPO_TEXTO NOMBRE IDENTIFICADOR VALOR_INICIAL TEXTO
| TIPO_BOOLEANO NOMBRE IDENTIFICADOR VALOR_INICIAL BOOL
| TIPO_LISTA_DE_ENTERO NOMBRE IDENTIFICADOR
| TIPO_LISTA_DE_TEXTO NOMBRE IDENTIFICADOR
| TIPO_LISTA_DE_REAL NOMBRE IDENTIFICADOR
| TIPO_MATRIZ_DE_BOOLEANO NOMBRE IDENTIFICADOR
| TIPO_MATRIZ_DE_TEXTO NOMBRE IDENTIFICADOR
| TIPO_MATRIZ_DE_ENTERO NOMBRE IDENTIFICADOR
| TIPO_MATRIZ_DE_REAL NOMBRE IDENTIFICADOR
))* FIN_VARIABLES;
...
imprimir: MOSTRAR_EN_PANTALLA expresion;
